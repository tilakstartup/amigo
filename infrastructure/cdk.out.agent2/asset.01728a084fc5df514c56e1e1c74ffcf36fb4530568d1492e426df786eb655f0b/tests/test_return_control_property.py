...
def _make_agent_response():
    ...
    mock_response.get.return_value = [
        {'chunk': {'bytes': b'{"status_of_aim":"in_progress","ui":{"render":{"type":"message","text":"ok"},"tone":"friendly"},"input":{"type":"text"},"previous_field_collected":null}'}}
    ]
...
def test_property_5_no_input_text_with_return_control(mock_bedrock, mock_verify, return_control_results):
    ...
    """
    mock_verify.return_value = {'sub': 'user-abc', 'subscription_status': 'free', 'is_active': True, 'credits': {}}
