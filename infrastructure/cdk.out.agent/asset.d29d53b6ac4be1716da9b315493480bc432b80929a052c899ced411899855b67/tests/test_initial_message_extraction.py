    ...
    with patch('index.bedrock_agent_runtime') as mock_bedrock:
        ...
        mock_response = {
            'completion': [
                {
                    'chunk': {
                        'bytes': b'{"status_of_aim": "in_progress", "ui": {"render": {"type": "message", "text": "Test"}, "tone": "supportive"}, "input": {"type": "text"}, "previous_field_collected": {"field": "test", "label": "Test", "value": "test_value"}}'
                    }
                }
            ]
        }
    ...
    with patch('index.bedrock_agent_runtime') as mock_bedrock:
        ...
        mock_response = {
            'completion': [
                {
                    'chunk': {
                        'bytes': b'{"status_of_aim": "in_progress", "ui": {"render": {"type": "message", "text": "Great!"}, "tone": "supportive"}, "input": {"type": "text"}, "previous_field_collected": null}'
                    }
                }
            ]
        }
