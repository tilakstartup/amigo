...
def _make_agent_response(text='{"status_of_aim":"in_progress","ui":{"render":{"type":"message","text":"ok"},"tone":"friendly"},"input":{"type":"text"},"current_field":{"field":"name","label":"Name","value":null}}'):
...
def _make_user_payload():
    return {'sub': 'user-abc', 'email': 'test@example.com', 'role': 'authenticated'}
